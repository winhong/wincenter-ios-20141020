...
void __CGContextAddRoundedRect(CGContextRef c, CGRect rect, CGFloat radius) {
...
void __CGContextFillRoundedRect(CGContextRef c, CGRect rect, CGFloat radius) {
	CGContextBeginPath(c);
	__CGContextAddRoundedRect(c, rect, radius);
	CGContextFillPath(c);
}
...
- (void)drawRect:(CGRect)rect {
	...
	__CGContextFillRoundedRect(c, self.bounds, LEGEND_ROUND_RADIUS);
