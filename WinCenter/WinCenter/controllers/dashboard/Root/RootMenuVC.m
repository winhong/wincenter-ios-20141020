...
@interface RootMenuVC ()<UIImagePickerControllerDelegate, UIActionSheetDelegate, VPImageCropperDelegate>
...
- (void)viewDidLoad
{
    ...
    self.portraitImageView.autoresizingMask = UIViewAutoresizingFlexibleLeftMargin | UIViewAutoresizingFlexibleRightMargin;
}
