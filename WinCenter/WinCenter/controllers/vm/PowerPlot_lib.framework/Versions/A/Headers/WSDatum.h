...
/** Return a datum with a Y-value (factory method). */
+ (instancetype)datumWithValue:(NAFloat)aValue;

/** Return a datum with an annotated Y-value (factory method). */
+ (instancetype)datumWithValue:(NAFloat)aValue
                    annotation:(NSString *)anno;

/** Return a datum of a X,Y-pairs (factory method). */
+ (instancetype)datumWithValue:(NAFloat)aValue
                        valueX:(NAFloat)aValueX;

/** Return a datum of an annotated X,Y-pairs (factory method). */
+ (instancetype)datumWithValue:(NAFloat)aValue
                        valueX:(NAFloat)aValueX
                    annotation:(NSString *)anno;
